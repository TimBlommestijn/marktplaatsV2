...
Route::get('/profile/{id}', [ProductController::class, 'profileProducts'])->name('profile-products');
Route::middleware(['auth:sanctum', 'verified'])->post('/product/image/save/{id}', [ProductController::class, 'storeImage'])->name('delete-image-product');
Route::middleware(['auth:sanctum', 'verified'])->post('/product/image/delete/{id}', [ProductController::class, 'deleteImage'])->name('delete-image-product');
