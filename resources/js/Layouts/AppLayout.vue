      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
          <div class="flex">
            ...
            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
              <jet-nav-link v-if="$page.user" :href="route('create-product')">
                Verkoop uw Product <i class="fas ml-2 fa-plus-circle"></i>
              </jet-nav-link>
            </div>
          </div>
      ...
      >
        ...
        <div class="pt-2 pb-3 space-y-1">
          <jet-responsive-nav-link
            ...
            :active="route().current('create-product')"
          >
        ...
        <div class="pt-4 pb-1 flex flex-col border-t border-gray-200" v-else>
          <jet-nav-link class="p-2 w-full ml-2 text-md" :href="route('login')"
            >login</jet-nav-link
          >
          <jet-nav-link
            class="p-2 w-full ml-2 text-md"
            :href="route('register')"
            >register</jet-nav-link
          >
        </div>
      </div>
    </nav>
